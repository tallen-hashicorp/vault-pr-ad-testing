...
def generate_config_file(username, password, domain_name, ami_id, pem_path):
...
def generate_config(username, password, domain_name, ami_id, pem_path):
    generate_config_file(username, password, domain_name, ami_id, pem_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--ami_id", default="ami-02076a196031326b2", help="AMI ID")
    ...
    generate_config(args.username, args.password, args.domain_name, args.ami_id, args.pem_path)
